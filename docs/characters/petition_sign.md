...
- <a id="f-petition_guid"></a>**`petition_guid`** - Part of the primary key. Charter item guid being signed.
- <a id="f-player_guid"></a>**`player_guid`** - Part of the primary key. Signer.
