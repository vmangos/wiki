...
- <a id="f-sender_guid"></a>**`sender_guid`** - Sender character guid (from [`characters`](characters.md).guid); system mails use special guids).
...
- <a id="f-checked"></a>**`checked`** - Status bitmask: 0x01 read · 0x02 returned · 0x04 copied · 0x08 COD paid · 0x10 has body.
