...
Scripts executed by in-game events (gameobject use/loot events, spell events, waypoint events, ...) - `id` is the event ID the core passes to `ScriptsStart`. Uses the [generic script system](../DB-Script-Tables.md).
