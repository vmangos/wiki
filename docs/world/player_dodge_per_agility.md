# player_dodge_per_agility Table

Defines how much dodge chance (in percent) each class gains per point of agility, scaled by level. Used in the player dodge chance calculation.
