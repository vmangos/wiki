...
Maps game objects to quests they offer (quest giver objects).
...
- <a id="f-id"></a>**`id`** - Primary Key. Game object template ID. (see [`gameobject_template`](gameobject_template.md).entry)
