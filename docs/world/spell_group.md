...
- <a id="f-group_spell_id"></a>**`group_spell_id`** - Part of the primary key. Companion group spell id; ordered by the loader but otherwise unused by the current core.
