...
Loot tables for skinning creatures.
...
- <a id="f-entry"></a>**`entry`** - Part of the primary key. Loot list id referenced by the owner system (see Loot System page). (see [`creature_template`](creature_template.md).skinning_loot_id)
