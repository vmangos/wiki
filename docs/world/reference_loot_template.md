...
Reference loot tables - reusable loot lists that can be referenced by other loot templates via negative `mincountOrRef` values.
...
- <a id="f-entry"></a>**`entry`** - Primary Key. Reference loot ID.
...
- <a id="f-maxcount"></a>**`maxcount`** - Maximum count.
