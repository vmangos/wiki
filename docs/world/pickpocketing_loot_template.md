...
- <a id="f-entry"></a>**`entry`** - Part of the primary key. Loot list id referenced by the owner system (see Loot System page). (see [`creature_template`](creature_template.md).pickpocket_loot_id)
