...
Loot tables for game objects (chests, containers, etc.).
...
- <a id="f-entry"></a>**`entry`** - Part of the primary key. Loot list id referenced by the owner system (see Loot System page). (see [`gameobject_template`](gameobject_template.md).loot_id)
