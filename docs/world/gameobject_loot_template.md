...
- <a id="f-entry"></a>**`entry`** - Primary Key. Loot list id referenced by the owner system (see Loot System page). (see [`gameobject_template`](gameobject_template.md).loot_id)
