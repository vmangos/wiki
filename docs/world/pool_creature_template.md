...
Links creature template IDs to spawn pools (reusable across multiple spawns).
...
- <a id="f-id"></a>**`id`** - Primary Key. Creature template ID ([`creature_template`](creature_template.md).entry).
